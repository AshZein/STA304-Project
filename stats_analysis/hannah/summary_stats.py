...
# plt.bar(season_summary['season'], season_summary['ticket_count'])
# plt.title("Total Tickets by Season")
# plt.xlabel("Season")
# plt.ylabel("Ticket Count")
# plt.show()

# plt.figure(figsize=(10,4))
# plt.bar(month_summary['month'], month_summary['ticket_count'])
...
# plt.bar(hour_summary['hour'], hour_summary['ticket_count'])
# plt.title("Total Tickets by Hour of Day")
# plt.xlabel("Hour")
# plt.ylabel("Ticket Count")
# plt.show()
